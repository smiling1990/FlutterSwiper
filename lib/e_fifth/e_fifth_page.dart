...
class EFifthPage extends StatefulWidget {
  @override
  _EFifthPageState createState() => _EFifthPageState();
}

class _EFifthPageState extends State<EFifthPage> {
  /// SwiperController
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('5. 实现页码展示')),
      body: ListView(
