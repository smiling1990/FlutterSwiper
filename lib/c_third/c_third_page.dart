...
class CThirdPage extends StatefulWidget {
  @override
  _CThirdPageState createState() => _CThirdPageState();
}

class _CThirdPageState extends State<CThirdPage> {
  /// SwiperController
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('3. 实现无限循环')),
      body: ListView(
